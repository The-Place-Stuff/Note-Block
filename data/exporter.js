...
/**
    Evaluates which audio service to use.
*/
...
/**
    Exports audio using Uberduck's API
*/
...
/**
    Exports audio using Streamlabs Polly API
*/
...
/**
    Exports audio using FakeYou API
*/
...
/**
    Exports audio using ElevenLabs API
*/
...
/**
    Downloads audio from the internet!
    @param {string} url URL location of the file to download.
    @param {string} outputPath Location of the output, once the download has finished.
*/
